import 'package:flutter/material.dart';
 ...
 class AppColor{
  ...
  static Color red = const Color(0xFFFF4D55);
  static Color grey = Colors.grey;
  static Color cardColor = const Color(0xFF212120);
...
//premium screen plan color
  ...
  static Color individualPlan = const Color(0x9EFFD5F4);
  static Color familyPlan = const Color(0xB595C8EA);
